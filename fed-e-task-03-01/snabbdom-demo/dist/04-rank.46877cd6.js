...
},{}],"src/originData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.originalData = void 0;

/*
 * @Author: LeeHuiXian
 * @version: 
 * @Date: 2020-09-28 15:22:28
 * @LastEditors: LeeHuiXian
 * @LastEditTime: 2020-09-28 15:23:30
 * @FilePath: /fed-e-task-03-01/snabbdom-demo/src/originData.js
 * @Description: 
 */
var originalData = [{
  rank: 1,
...
},{}],"src/04-rank.js":[function(require,module,exports) {
"use strict";
...
var _originData = require("./originData");
...
var data = _originData.originalData;
var app = document.querySelector('#app');
var sortBy = 'rank';
var vnode = view(data); // 初次渲染

var oldVnode = patch(app, vnode); // 渲染
...
function view(data) {
  return (0, _snabbdom.h)('div#container', [(0, _snabbdom.h)('h1', 'Top 10 movies'), (0, _snabbdom.h)('div', [(0, _snabbdom.h)('a.btn.add', {
    style: {
      marginRight: '10px',
      color: 'red'
    },
  ...
  }, 'Description')])]), (0, _snabbdom.h)('div.list', data.map(movieView))]);
} // 创建单条数据
...
function movieView(movie) {
  ...
  }, movie.rank), (0, _snabbdom.h)('div', {
    style: {
      marginRight: '10px',
      minWidth: '200px',
      textAlign: 'center'
    }
  }, movie.title), (0, _snabbdom.h)('div', {
    style: {
      marginRight: '10px'
    }
  }, movie.desc), (0, _snabbdom.h)('div.btn.rm-btn', {
    style: {
      marginRight: '10px'
    },
    on: {
...
function add() {
  var n = _originData.originalData[Math.floor(Math.random() * 10)];
...
},{"snabbdom":"node_modules/snabbdom/es/snabbdom.js","snabbdom/modules/style":"node_modules/snabbdom/modules/style.js","snabbdom/modules/eventlisteners":"node_modules/snabbdom/modules/eventlisteners.js","./originData":"src/originData.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/04-rank.js"], null)
//# sourceMappingURL=/04-rank.46877cd6.js.map