 ...
 * @Author: LeeHuiXian
 * @version: 
 * @Date: 2020-09-24 21:50:35
 * @LastEditors: LeeHuiXian
 * @LastEditTime: 2020-09-24 21:59:22
 * @FilePath: /fed-e-task-03-01/snabbdom-demo/src/03-modules.js
 * @Description: 
 */
// 1. 导入模块
// 2. init注册模块
var patch = (0, _snabbdom.init)([_style.default, _eventlisteners.default]); // 3. 使用 h() 函数的第二个参数传入模块的需要的数据（对象）
